...
import * as authService from '@/firebase/auth/auth';
...
export default function GoogleLoginButton() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      localStorage.setItem('craftly_user', JSON.stringify(sessionData));

      // Dispatch custom event to update useUser hook
      window.dispatchEvent(
        new CustomEvent('craftly-user-changed', { detail: sessionData })
      );
